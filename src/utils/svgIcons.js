...
export const svgIcons = {
    getFireIcon: function (name) {
        switch (name) {
            case "markers--Burn_Area":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--Burn_Area" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17.8 14.8c1.6 0 2-.9 2-1.8s.8-3.7.8-5.5.8-4.2 2-4.2c1.3 0 1.7 2 1.7 4.2s-1.3 4.3 0 5.5c1.3 1.3 2 .5 3.4 1.8s2 4.7 1.3 5.5c-.8.9-2 4.8-3.9 4.8-1.7 0-3-.2-4-1.3-1-1-3.4-2-3.4-1.4 0 .8-.2 1.7.8 2.6 1 .9 1.4 2.8 0 2.8s-.5-.5-1.6-1.6-.9-2.3-3.1-2.9c-2.3-.8-3.3-4.2-5.4-4.2s-4.9.2-4.9-1.1 0-2.6-.9-3.4C1.7 13.8.2 12 1 11.2c.9-.9 1.6-.9 1.6-2.3s.1-4.5 1.1-4.5S5.6 8.8 6.6 10c1.2 1.2 5.7-.9 6.8.2s2.9 1.3 2.9 2.4c-.1 1 1.5 2.2 1.5 2.2z" fill="%23989898" stroke="%23676767" stroke-miterlimit="10"/>
                </svg>`;
            case "markers--closure--Airport_Closure":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Airport_Closure" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M16 0C7.2 0 0 7.2 0 16s7.2 16 16 16 16-7.2 16-16S24.8 0 16 0zM2 16C2 8.3 8.3 2 16 2c3.8 0 7.2 1.5 9.7 3.9L5.9 25.7C3.5 23.2 2 19.8 2 16zm14 14c-3.2 0-6.2-1.1-8.6-3L27 7.4c1.9 2.4 3 5.4 3 8.6 0 7.7-6.3 14-14 14z" fill="%23ED2F22"/>
                </svg>`;
            case "markers--closure--Other_Closed":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Other_Closed" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    <path d="M15 0C6.8 0 0 6.8 0 15s6.7 15 15 15 15-6.7 15-15S23.2 0 15 0zM1.9 15C1.9 7.8 7.8 1.9 15 1.9c3.6 0 6.7 1.4 9.1 3.7L5.5 24.1c-2.2-2.4-3.6-5.5-3.6-9.1zM15 28.1c-3 0-5.8-1-8.1-2.8L25.3 6.9c1.8 2.2 2.8 5.1 2.8 8.1 0 7.2-5.9 13.1-13.1 13.1z" fill="%23ED2F22"/>
                </svg>`;
            case "markers--closure--Park_Closed":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Park_Closed" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--closure--Port_Closure":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Port_Closure" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="16" cy="16" fill="%23FFF" r="15"/>
                    <path d="M23 17v-2h-2v-4l-3 .5V15h-1v-4l-2 .5V15h-1v-4l-3 .5V15H9v2H4l4 5h16.1l3.9-5z"/>
                    <path d="M16 0C7.2 0 0 7.2 0 16s7.2 16 16 16 16-7.2 16-16S24.8 0 16 0zM2 16C2 8.3 8.3 2 16 2c3.8 0 7.2 1.5 9.7 3.9L5.9 25.7C3.5 23.2 2 19.8 2 16zm14 14c-3.2 0-6.2-1.1-8.6-3L27 7.4c1.9 2.4 3 5.4 3 8.6 0 7.7-6.3 14-14 14z" fill="%23ED2F22"/>
                </svg>`;
            case "markers--closure--Rail_Disruptions":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Rail_Disruptions" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    ...
                    <path d="M15 0C6.8 0 0 6.8 0 15s6.8 15 15 15 15-6.8 15-15S23.2 0 15 0zM1.9 15C1.9 7.8 7.8 1.9 15 1.9c3.6 0 6.8 1.4 9.1 3.7L5.5 24.1c-2.2-2.3-3.6-5.5-3.6-9.1zM15 28.1c-3 0-5.8-1-8.1-2.8L25.3 6.9c1.8 2.2 2.8 5.1 2.8 8.1 0 7.2-5.9 13.1-13.1 13.1z" fill="%23ED2F22"/>
                </svg>`;
            case "markers--closure--Road_Closed":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Road_Closed" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--closure--Road_Works":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Road_Works" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M.54 15.544L15.558.526l13.614 13.615-15.018 15.018z" fill="%23fff"/>
            ...
            case "markers--closure--School_Closure":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--School_Closure" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--closure--Total_Fire_Ban":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Total_Fire_Ban" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.8-.3L.3 15.2l15.6 15.4 15.5-15.5z" fill="%23FFF"/>
                    <g transform="scale(3)">
                        <circle cx="5" cy="5" fill="%23FFF" r="5"/>
                        <path d="M5 0C2.3 0 0 2.3 0 5s2.2 5 5 5 5-2.2 5-5-2.3-5-5-5zM.7 5C.7 2.6 2.7.6 5.1.6c1.2 0 2.2.5 3 1.2L1.9 8C1.1 7.2.7 6.2.7 5zM5 9.3c-1 0-1.9-.3-2.7-.9l6.1-6.1c.6.8 1 1.7 1 2.7 0 2.4-2 4.3-4.4 4.3z" fill="%23ED2F22"/>
                    </g>
            ...
            case "markers--closure--Track_Closed":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--closure--Track_Closed" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--cluster":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--cluster" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="8.1" cy="8.1" fill="%2309F" r="7" stroke="%23FFF"/>
                    <path d="M8.1 3.1v10M3.1 8.1h10" fill="none" stroke="%23FFF" stroke-width="2"/>
                </svg>`;
            case "markers--community--Community_Document":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--community--Community_Document" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23007500" r="13.8" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                    <g fill="%23FFF">
                    ...
                    <g>
                        <circle cx="15" cy="15" fill="%23007500" r="13.1"/>
                        <path d="M15 29C7.3 29 1 22.7 1 15S7.3 1 15 1s14 6.3 14 14-6.3 14-14 14zm0-26.2C8.3 2.8 2.8 8.3 2.8 15S8.3 27.2 15 27.2 27.2 21.7 27.2 15 21.7 2.8 15 2.8z" fill="%23FFF"/>
                        <path d="M9.8 8.9v12.2h10.5V8.9H9.8zm1.7 2.6H15v1.8h-3.5v-1.8zm7 7h-7v-1.8h7v1.8zm0-2.6h-7v-1.8h7v1.8z" fill="%23FFF"/>
                    </g>
                </svg>`;
            case "markers--community--Community_Information_Point":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--community--Community_Information_Point" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23007500" r="13.8" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                    <g fill="%23FFF">
                        <circle cx="10" cy="12.2" r="1.8"/>
                        <path d="M11.2 17.8c0-.7.2-1.4 1.1-1.6v-.3c0-.4-.3-.8-.6-.8H8.3c-.4 0-.6.5-.6.8v4c0 .4.3.6.6.6h3c-.1 0-.1-2.8-.1-2.7z"/>
                    ...
                    <g>
                        <circle cx="15" cy="15" fill="%23007500" r="13.1"/>
                        <path d="M16.3 7.8c1 0 1.4.6 1.4 1.4 0 .9-.8 1.8-1.8 1.8-.9 0-1.4-.5-1.4-1.4 0-.8.6-1.8 1.8-1.8zm-2.9 14c-.7 0-1.3-.4-.8-2.4l.9-3.6c.2-.6.2-.8 0-.8-.3 0-1.2.4-1.8.8l-.3-.6c1.8-1.5 3.9-2.5 4.7-2.5.7 0 .9.9.5 2.3l-1 3.8c-.2.7-.1.9.1.9.3 0 1-.3 1.7-.9l.4.6c-1.7 1.7-3.7 2.4-4.4 2.4z" fill="%23FFF"/>
                        <path d="M15 29C7.3 29 1 22.7 1 15S7.3 1 15 1s14 6.3 14 14-6.3 14-14 14zm0-26.2C8.3 2.8 2.8 8.3 2.8 15S8.3 27.2 15 27.2 27.2 21.7 27.2 15 21.7 2.8 15 2.8z" fill="%23FFF"/>
                    </g>
                </svg>`;
            case "markers--community--Community_Refuge":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--community--Community_Refuge" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23007500" r="13.8" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                    <g fill="%23FFF">
                        <circle cx="10" cy="12.2" r="1.8"/>
                        <path d="M11.2 17.8c0-.7.2-1.4 1.1-1.6v-.3c0-.4-.3-.8-.6-.8H8.3c-.4 0-.6.5-.6.8v4c0 .4.3.6.6.6h3c-.1 0-.1-2.8-.1-2.7z"/>
                    ...
                    <g>
                        <circle cx="15" cy="15" fill="%231E5DA7" r="14" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                        <path d="M7.5 22.5h14.9v.9H7.5zM21.5 22.5h1V12.2l-1-.9zM7.5 12.2h.9v10.3h-.9z" fill="%23FFF"/>
                        <g fill="%23FFF">
                        ...
                        <path d="M13.7 16.9h2.8v4.7h-2.8zM7.5 13.1H5.7L15 4.7l9.3 8.4h-1.8L15 6.6z" fill="%23FFF"/>
                    </g>
                </svg>`;
            case "markers--community--Community_Relief_Centre":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--community--Community_Relief_Centre" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23007500" r="13.8" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                    <g fill="%23FFF">
                        <circle cx="10" cy="12.2" r="1.8"/>
                        <path d="M11.2 17.8c0-.7.2-1.4 1.1-1.6v-.3c0-.4-.3-.8-.6-.8H8.3c-.4 0-.6.5-.6.8v4c0 .4.3.6.6.6h3c-.1 0-.1-2.8-.1-2.7z"/>
                    ...
                    <g>
                        <circle cx="15" cy="15" fill="%23007500" r="14" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                        <path d="M7.5 22.5h14.9v.9H7.5zM21.5 22.5h1V12.2l-1-.9zM7.5 12.2h.9v10.3h-.9z" fill="%23FFF"/>
                        <g fill="%23FFF">
                            <circle cx="11.3" cy="12.9" r="1.7"/>
                            <path d="M12.2 16.8c0-.6 0-.9.9-1.1v-.2c0-.3-.5-.4-.7-.4h-1.5c-.3 0-.6.1-.6.4v3.1c0 .3.2.3.6.3H12.1c0-.2.1-2.2.1-2.1z"/>
            ...
            case "markers--community--Community_Siren":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--community--Community_Siren" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23007500" r="13.8" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                    <g fill="%23FFF">
                        <circle cx="10" cy="12.2" r="1.8"/>
                        <path d="M11.2 17.8c0-.7.2-1.4 1.1-1.6v-.3c0-.4-.3-.8-.6-.8H8.3c-.4 0-.6.5-.6.8v4c0 .4.3.6.6.6h3c-.1 0-.1-2.8-.1-2.7z"/>
            ...
            case "markers--community--Neighbourhood_Safer_Place":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--community--Neighbourhood_Safer_Place" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23007500" r="13.8" stroke="%23FFF" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
                    <g fill="%23FFF">
                        <circle cx="10" cy="12.2" r="1.8"/>
                        <path d="M11.2 17.8c0-.7.2-1.4 1.1-1.6v-.3c0-.4-.3-.8-.6-.8H8.3c-.4 0-.6.5-.6.8v4c0 .4.3.6.6.6h3c-.1 0-.1-2.8-.1-2.7z"/>
            ...
            case "markers--incident--Accident_Collision":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Accident_Collision" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 .4L.3 14.9 15 29.5l14.6-14.6z" fill="%23FFF"/>
            ...
            case "markers--incident--Aircraft_Incident":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Aircraft_Incident" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1.5L.4 15.1l14.7 14.5L29.7 15z" fill="%23FFF"/>
            ...
            case "markers--incident--Animal_Health":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Animal_Health" overflow="scroll" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path d="M50 4.75L95.5 49l-46 47.75L2.5 51z" fill="%23FFF"/>
            ...
            case "markers--incident--Beach_Closures":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Beach_Closures" overflow="scroll" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="50.033" cy="49.983" fill="%23FFF" r="44.75"/>
                    <circle cx="72.868" cy="44.568" fill="%23FFF" r="7.066"/>
                    <path d="M43.223 74.685c1.267-2.018 2.851-4.089 4.758-5.721 2.9-2.481 8.474-4.605 13.055-6.997l1.061 13.714a4.137 4.137 0 0 0 1.185 2.591l7.052 7.118a4.135 4.135 0 0 0 5.848.028 4.133 4.133 0 0 0 .029-5.848l-5.983-6.042-1.331-17.197c-.053-.675-.208-2.952-.249-3.044-1.5-3.384-5.587-6.174-5.587-6.174s-1.733-1.753-2.734-2.633l-10.612-9.33a4.142 4.142 0 0 0-3.564-.946l-19.042 3.911A4.14 4.14 0 0 0 23.889 43a4.128 4.128 0 0 0 1.319 2.272 4.128 4.128 0 0 0 3.566.948L45.8 42.723l6.205 5.455c-1.3.26-2.657.593-4.074 1.008-6.663 1.952-11.625 5.837-14.676 8.835a4.125 4.125 0 0 0-1.257.935l-11.86 13.065" fill="%23FFF"/>
                    <path d="M17.733 80.922a4.138 4.138 0 0 0 5.795-.327l11.125-10.957c.28.221.876.403.784.804" fill="%23FFF"/>
                    ...
                    <g>
                        <path d="M21.74 87.331S-.834 62.05 5.666 60.3s7.75-5.95 14.5-5.95 8 6.45 14 6.45 8.25-6.5 15-6.5 9.125 6.5 15 6.5 8.375-6.5 15.5-6.5c6.5 0 6.875 4.5 12.25 4.5s3.25 6.5 3.25 6.5l-15.26 21.198-29.833 9.667-28.333-8.834z" fill="%23FFF"/>
                    ...
                    <g>
                        <path d="M78.25 16.166l4.241 4.242-62.635 62.636-4.242-4.242z" fill="%23EC0A47"/>
                    </g>
                    <g>
                        <path d="M50.15 99.233c-26.927 0-48.833-21.906-48.833-48.833S23.223 1.566 50.15 1.566 98.984 23.474 98.984 50.4 77.076 99.233 50.15 99.233zm0-91.667C26.532 7.566 7.317 26.781 7.317 50.4c0 23.618 19.215 42.833 42.833 42.833 23.619 0 42.834-19.215 42.834-42.833 0-23.619-19.215-42.834-42.834-42.834z" fill="%23EC0A47"/>
                    </g>
                </svg>`;
            case "markers--incident--Building_damage":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Building_damage" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                    <path d="M9.1 14.4h12.3v5.7H9.1z"/>
                    <path d="M6.2 14.8l8.9-7.5 8.8 7.5z"/>
                    <path d="M9.4 8.6h2v3.9h-2z"/>
                    <path d="M13.5 16h3.4v4.1h-3.4z" fill="%23FFF"/>
                    <path d="M15.1 16.6c-.6-1.9-.6-2-.6-2.2 0-.5.2-.8 1.8-1.6l-.6-1.2c-.1-.3-.1-.7.1-1l1.7-2.1L19 9.7l-1.4 1.7.7 1.5c.2.4 0 1-.4 1.2-.5.2-1 .5-1.4.7.1.4.2.8.4 1.3l-1.8.5z" fill="%23FFF"/>
                </svg>`;
            case "markers--incident--Dam_Failure":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Dam_Failure" overflow="scroll" viewBox="0 0 93.75 93.75" xmlns="http://www.w3.org/2000/svg">
                    <path d="M92.23 43.388l-44.742 44.67-45.715-42.8L47.974 1.992z" fill="%23fff"/>
            ...
            case "markers--incident--Earthquake":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Earthquake" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.2.5L.5 15.1l14.7 14.5L29.8 15z" fill="%23FFF"/>
                    <path d="M7.3 21.7h15.5l-7.5 7.2zM9.2 15.3h12.3V21H9.2z"/>
                    <path d="M6.4 15.7l8.8-7.4 8.8 7.4z"/>
                    <path d="M9.5 9.5h2v3.9h-2z"/>
                    <path d="M14.3 28.9c-1.8-5.9-1.8-6-1.8-6.2 0-.6 0-.7 4.2-3.8L14 16.3c-.4-.4-.4-1-.1-1.4l3.3-4 1.6 1.4-2.7 3.2 2.9 2.8c.2.2.3.5.3.8 0 .3-.2.6-.4.8-1.6 1.2-3.4 2.5-4.2 3.2.3 1.1 1.1 3.6 1.6 5.3l-2 .5z" fill="%23FFF"/>
            ...
            case "markers--incident--Fallen_Power_Lines":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Fallen_Power_Lines" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.4L15 29.1.8 15.3z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7s.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
            ...
            case "markers--incident--Fire":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Fire" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
            ...
            case "markers--incident--Fire_Active":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Fire_Active" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M20.75 12.293s-.001 1.196-.28 2.423c-.605-2.62-2.4-4.834-2.4-4.834-.253 4.11-2.456 4.507-2.456 4.507s.69-1.167.767-3.35c.09-2.528-2.078-4.253-2.078-4.253l-.629 2.272c-.217.786-.811 1.426-1.494 2.077-.385-1.505-1.726-2.413-1.79-2.456.036.026.303.258.35 1.587.05 1.424-2.376 2.74-2.527 5.314-.204 3.456 3.155 5.358 4.069 5.81.773.681 1.393 1.072 1.393 1.072-.963-2.553-.803-3.864-.104-4.964.759-1.193 2.275-1.534 2.275-1.534-1.618 2.465 1.01 2.769.72 6.498 0 0 .52-.1 1.22-.603 1.074-.483 3.211-1.768 3.772-4.526.758-3.725-.809-5.04-.809-5.04z" fill="%23fff"/>
                </svg>`;
            case "markers--incident--Hazardous_Material":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Hazardous_Material" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.8.1L.2 14.7l14.6 14.5 14.7-14.6z" fill="%23FFF"/>
            ...
            case "markers--incident--Hazardous_Material_Gas_Leak":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Hazardous_Material_Gas_Leak" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7s.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                    ...
                    <path d="M16.6 9.3c0 .2-.2.4-.4.4h-.3c-.2 0-.4-.2-.4-.4v-.8c0-.2.2-.4.4-.4h.3c.2 0 .4.2.4.4v.8zM14.6 9.3c0 .2-.2.4-.4.4h-.3c-.2 0-.4-.2-.4-.4v-.8c0-.2.2-.4.4-.4h.3c.2 0 .4.2.4.4v.8z" fill="%23FFF"/>
                </svg>`;
            case "markers--incident--Hazardous_Material_Liquids":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Hazardous_Material_Liquids" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                    <path d="M19 16.4c-.4-3.1-3-4.4-3.9-9.1v-.1.1c-.9 4.7-3.6 6.2-3.9 9.1-.5 4 2.4 5 3.9 5s4.3-1.2 3.9-5z"/>
                </svg>`;
            case "markers--incident--Health":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Health" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1.4L.4 15l14.7 14.5 14.6-14.6z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                    <circle cx="14.7" cy="13.7" r="4.6"/>
                    <path d="M6 21.5s2.1-4.3 8.9-4.3 8.5 5.2 8.5 5.2-6.6 5.9-8.7 5.9S6 21.5 6 21.5z"/>
                    <path d="M15.7 18.9h1.8v5.4h-1.8z" fill="%23FFF"/>
                    <path d="M13.9 20.7h5.4v1.8h-5.4z" fill="%23FFF"/>
            ...
            case "markers--incident--Landslide":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Landslide" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
            ...
            case "markers--incident--Locust_Plague":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Locust_Plague" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 1.3l13.8 13.3L14.9 29 .7 15.2z" fill="%23FFF"/>
            ...
            case "markers--incident--Oiled_Wildlife":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Oiled_Wildlife" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                    ...
                    <path d="M15.2 19.5c-.1.4-.1.7-.2 1.1v.1c-.1.4-.3.5-.6.4-.2 0-.5-.1-.7-.2-.2-.1-.4-.3-.5-.5-.3-.6-.5-1.2-.7-1.9-.2-1 0-2 .4-2.9.2-.6.2-1.1.2-1.7 0-.3-.1-.6-.1-.9 0-.4.1-.7.2-1.1.1-.4.3-.9.4-1.3.1-.3.1-.6.2-.9 0-.2.1-.3.1-.5 0-.3.1-.3.3-.2.1.1.2.1.2.2l.2.2c.4.4.9.3 1.2-.1 0-.1.1-.1.1-.2L16 9v.5c-.1.7.1 1.3.4 1.9.2.5.4 1 .5 1.5.1.4.1.8.1 1.1 0 1 0 2.1-.1 3.1-.1 1.1-.4 2.2-.9 3.2-.1.1-.2.3-.3.4-.1.1-.2.1-.3.1-.1 0-.2-.1-.2-.2-.1-.3-.1-.6-.1-.9.1-.1.1-.1.1-.2z" fill="%23FFF"/>
            ...
            case "markers--incident--Other_Incident":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Other_Incident" overflow="scroll" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path d="M49.75 1.5L1.25 49.75l48.56 48.149L98.25 49.5z" fill="%23FFF"/>
            ...
            case "markers--incident--Petroleum_Oil_Spill":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Petroleum_Oil_Spill" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                    ...
                    <ellipse cx="14" cy="9.8" rx="1.3" ry="3.3" transform="matrix(.0062 -1 1 .0062 4.176 23.746)"/>
                    <path d="M10.7 9.8h6.7V19h-6.7z"/>
                    <ellipse cx="14" cy="9.7" fill="%23FFF" rx="2.7" ry=".9"/>
                    <ellipse cx="12.8" cy="9.7" rx=".9" ry=".3"/>
                    <path d="M11.9 10.9c0 .1.1.2.1.2 0 .1.1.1.1.2s.1.1.2.1h.1l.1-.1H12.8l.2.1h.1s.1 0 .1.1c.1 0 .2.1.2.1.1.1.3.2.4.3.1.1.2.3.3.4.1.1.1.3.1.4v.4c0 .1-.1.2-.1.3 0 .1-.1.1-.1.1h-.1l-.1-.1c-.1 0-.1-.1-.2-.1s-.2-.1-.2-.1H13h-.1-.1H12.5s.1 0 0 0-.2-.1-.2-.1c-.2-.1-.3-.2-.5-.3-.1-.1-.3-.3-.4-.5-.1-.2-.1-.4 0-.6 0-.2.1-.3.2-.4.1-.1.2-.1.2-.2-.1-.2-.1-.2.1-.2-.1 0 0 0 0 0zM11.9 13.2c0 .1.1.2.1.2 0 .1.1.1.1.2s.1.1.2.1h.1l.1-.1H12.8l.2.1h.1s.1 0 .1.1c.1 0 .2.1.2.1.1.1.3.2.4.3.1.1.2.3.3.4.1.1.1.3.1.4v.4c0 .1-.1.2-.1.3 0 .1-.1.1-.1.1h-.1l-.1-.1c-.1 0-.1-.1-.2-.1s-.2-.1-.2-.1H13h-.1-.1H12.5s.1 0 0 0-.2-.1-.2-.1c-.2-.1-.3-.2-.5-.3-.1-.1-.3-.3-.4-.5-.1-.2-.1-.4 0-.6 0-.2.1-.3.2-.4.1-.1.2-.1.2-.2-.1-.1-.1-.2.1-.2-.1 0 0 0 0 0zM11.9 15.5s0 .1 0 0c0 .1.1.2.1.2 0 .1.1.1.1.2s.1.1.2.1h.1l.1-.1H12.8l.2.1h.1s.1 0 .1.1c.1 0 .2.1.2.1.1.1.3.2.4.3.1.1.2.3.3.4.1.1.1.3.1.4v.4c0 .1-.1.2-.1.3 0 .1-.1.1-.1.1h-.1l-.1-.1c-.1 0-.1-.1-.2-.1s-.2-.1-.2-.1H13h-.1-.1H12.5s.1 0 0 0-.2-.1-.2-.1c-.2-.1-.3-.2-.5-.3-.1-.1-.3-.3-.4-.5-.1-.2-.1-.4 0-.6 0-.2.1-.3.2-.4.1-.1.2-.1.2-.2-.1-.1-.1-.1.1-.2-.1 0 0 0 0 0z" fill="%23FFF"/>
                </svg>`;
            case "markers--incident--Planned_Burn":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Planned_Burn" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17.6 27.6c-1.4 1.4-3.7 1.4-5.2 0l-10-10c-1.4-1.4-1.4-3.7 0-5.2l10-10c1.4-1.4 3.7-1.4 5.2 0l10 10c1.4 1.4 1.4 3.7 0 5.2l-10 10z" fill="%23FFF"/>
                    <path d="M15 30c-1.3 0-2.6-.5-3.5-1.5l-10-10C.5 17.6 0 16.3 0 15c0-1.3.5-2.6 1.5-3.5l10-10C12.4.5 13.7 0 15 0c1.3 0 2.6.5 3.5 1.5l10 10c.9.9 1.5 2.2 1.5 3.5 0 1.3-.5 2.6-1.5 3.5l-10 10c-.9 1-2.2 1.5-3.5 1.5zm0-27.3c-.6 0-1.2.2-1.6.7l-10 10c-.4.4-.7 1-.7 1.6 0 .6.2 1.2.7 1.6l10 10c.4.4 1 .7 1.6.7s1.2-.2 1.6-.7l10-10c.4-.4.7-1 .7-1.6 0-.6-.2-1.2-.7-1.6l-10-10c-.4-.5-1-.7-1.6-.7z" fill="%23FFF"/>
            ...
            case "markers--incident--Plant_Pest_Disease":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Plant_Pest_Disease" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    ...
                    <path d="M18.2 19.5s-.1-.1-.3-.2c-.2-.2-.5-.4-.8-.6-.6-.6-1.4-1.4-2.1-2.3-.3-.5-.6-.9-.8-1.4-.1-.2-.2-.5-.3-.7-.1-.2-.2-.4-.2-.6-.1-.4-.2-.7-.2-1 0-.2-.1-.4-.1-.4s.1.1.1.3c.1.2.2.5.4.9l.3.6c.1.2.3.4.4.6.3.4.6.8 1 1.1.7.7 1.6 1.3 2.3 1.7.3.2.6.3.8.4.2.1.3.1.3.1.4.2.6.7.3 1.1-.2.5-.7.6-1.1.4z" fill="%23FFF"/>
            ...
            case "markers--incident--Rail_Incident":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Rail_Incident" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 .5L.3 15.1 15 29.6 29.6 15z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
            ...
            case "markers--incident--Rescue":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Rescue" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path d="M49.75 1.5L1.25 49.75l48.56 48.149L98.25 49.5z" fill="%23FFF"/>
                    <path d="M49.56 99.399c-4.512 0-8.746-1.746-11.921-4.922L4.803 61.64C1.627 58.466-.12 54.231-.12 49.719s1.748-8.746 4.923-11.921L37.639 4.961C40.813 1.785 45.048.038 49.56.038s8.746 1.749 11.92 4.923l32.839 32.837c6.573 6.573 6.573 17.268 0 23.842L61.48 94.477c-3.173 3.176-7.408 4.922-11.92 4.922zm0-90.619a8.06 8.06 0 0 0-5.74 2.362L10.983 43.978a8.06 8.06 0 0 0-2.362 5.74 8.06 8.06 0 0 0 2.362 5.74L43.82 88.297c3.046 3.044 8.431 3.044 11.479 0l32.839-32.838c3.163-3.165 3.163-8.316 0-11.481L55.299 11.142A8.059 8.059 0 0 0 49.56 8.78z"/>
            ...
            case "markers--incident--Severe_Weather":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Severe_Weather" overflow="scroll" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path d="M49.5 4.75L95 49 49 96.75 2 51z" fill="%23FFF"/>
            ...
            case "markers--incident--Shark_Sighting":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Shark_Sighting" overflow="scroll" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path d="M50 4.75L95.5 49l-46 47.75L2.5 51z" fill="%23FFF"/>
                    <path d="M67.083 53.25S56.847 26.656 38.597 24.156c-.727.363 6.5 18.25 1.736 27.094-2.965 5.504 26.75 2 26.75 2z"/>
                    <path d="M43.083 95.3S-.667 55.55 5.833 53.8s7.75-5.95 14.5-5.95 8 6.45 14 6.45 8.25-6.5 15-6.5 9.125 6.5 15 6.5 8.375-6.5 15.5-6.5c6.5 0 6.875 4.5 12.25 4.5s3.25 6.5 3.25 6.5l-39.75 37.25-12.5-.75z" fill="%23FFF"/>
                    ...
                    <g>
                        <path d="M46.119 94.571s-11.38-11.242-15.697-15.047c-5.311-4.681-10.1-5.702-4.33-5.776 5.77-.075 6.91 5.425 12.04 5.358 5.129-.067 7.481-5.605 13.251-5.68 5.82-.076 7.422 5.411 12.394 5.346 5.022-.065 7.087-5.65 13.178-5.729 5.557-.072-.528 2.809-3.027 6.665-.98 1.513-1.48 1.519-1.48 1.519L56.122 94.691l-10.003-.12z" fill="%23FFF"/>
            ...
            case "markers--incident--Ship_Incident":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Ship_Incident" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.2l13.8 13.4L15 29 .8 15.2z" fill="%23FFF"/>
            ...
            case "markers--incident--Tree_Hazard":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Tree_Hazard" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.2 1.3l13.7 13.3L15 29 .9 15.2z" fill="%23FFF"/>
            ...
            case "markers--incident--Vertebrate_Animal_Plague":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Vertebrate_Animal_Plague" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    ...
                    <ellipse cx="11" cy="11.5" rx="1.7" ry="1.1" transform="rotate(-76.461 10.963 11.456)"/>
            ...
            case "markers--incident--Water_pollution":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--incident--Water_pollution" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 1.3l13.7 13.2-13.8 14.3L.8 15.1z" fill="%23FFF"/>
                    ...
                    <path d="M12.2 23c-.3 0-.7-.1-.9-.2l-2.2-1-2.1.7-.8-2.3 2.2-.7c.5-.2 1.2-.1 1.7.1l2.2 1 2.3-.9c.5-.2 1.1-.2 1.6 0l2.4.8h.1l2-.7c.5-.2 1.1-.2 1.6-.1l2.1.6-.7 2.3-2.1-.6h-.1l-2 .7c-.5.2-1.1.2-1.6 0l-2.6-.7h-.1l-2.4.9c-.1.1-.4.1-.6.1z" fill="%23FFF"/>
                    ...
                    <circle cx="20" cy="11.5" fill="%23FFF" r=".6"/>
                </svg>`;
            case "markers--media--Media_Assembly_Point":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--media--Media_Assembly_Point" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--outage--Electricity_Outage":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--outage--Electricity_Outage" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--outage--Gas_Outage":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--outage--Gas_Outage" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--outage--Water_Outage":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--outage--Water_Outage" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--quarantine--Special_Restricted_area_Animal_Health":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--quarantine--Special_Restricted_area_Animal_Health" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    ...
                    <path d="M15.3 0C6.9-.1.1 6.5 0 14.7S6.5 29.9 14.7 30c8.3.1 15.2-6.5 15.3-14.7C30.1 7 23.5.1 15.3 0zM1.9 14.8C2 7.6 8 1.8 15.2 1.9c3.6.1 6.7 1.5 9 3.8L5.4 23.9c-2.2-2.3-3.6-5.6-3.5-9.1zm12.9 13.3c-3-.1-5.8-1.1-8-2.9L25.5 7.1c1.7 2.2 2.6 5.1 2.6 8.1-.1 7.2-6.1 13-13.3 12.9z" fill="%23ED2F22"/>
                </svg>`;
            case "markers--quarantine--Special_Restricted_area_Plant_Health":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--quarantine--Special_Restricted_area_Plant_Health" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--quarantine--Special_Restricted_area_Quarantine":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--quarantine--Special_Restricted_area_Quarantine" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
            ...
            case "markers--social--Facebook":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--social--Facebook" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    <path d="M15 30C6.8 30 0 23.2 0 15S6.8 0 15 0s15 6.8 15 15-6.8 15-15 15zm0-28.1C7.8 1.9 1.9 7.8 1.9 15S7.8 28.1 15 28.1 28.1 22.2 28.1 15 22.2 1.9 15 1.9z" fill="%231E5DA7"/>
                    <path d="M18.5 8.4h-2.2c-1.9 0-3.2 1.3-3.2 3.2v1.5h-1.6c-.2 0-.3.1-.3.3v2.3c0 .2.1.3.3.3h1.7v5.3c0 .2.1.3.3.3h2.3c.2 0 .3-.1.3-.3V16h2.5c.2 0 .3-.1.3-.3v-2.2c0-.1 0-.1-.1-.2 0-.1-.1-.1-.2-.1h-2.5V12c0-.6.2-.9 1-.9h1.5c.2 0 .3-.1.3-.3v-2c-.1-.3-.2-.4-.4-.4z" fill="%231E5DA7"/>
                </svg>`;
            case "markers--social--Instagram":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--social--Instagram" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    <path d="M15 30C6.8 30 0 23.2 0 15S6.8 0 15 0s15 6.8 15 15-6.8 15-15 15zm0-28.1C7.8 1.9 1.9 7.8 1.9 15S7.8 28.1 15 28.1 28.1 22.2 28.1 15 22.2 1.9 15 1.9z" fill="%231E5DA7"/>
                    <path d="M10.1 8.4h9.8c.9 0 1.7.7 1.7 1.7v9.8c0 1-.8 1.7-1.7 1.7h-9.8c-.9 0-1.7-.7-1.7-1.7v-9.8c0-1 .8-1.7 1.7-1.7zm7.3 1.9c-.3 0-.6.3-.6.6v1.4c0 .3.3.6.6.6H19c.3 0 .6-.3.6-.6v-1.4c0-.3-.3-.6-.6-.6h-1.6zm2.3 3.8h-1.1c.1.4.2.7.2 1 0 2.2-1.5 3.9-3.8 3.9s-3.8-1.8-3.8-3.9c0-.4.1-.7.2-1h-1.1v5.4c0 .3.3.6.6.6h8.3c.3 0 .6-.3.6-.6l-.1-5.4zm-4.7-1c-1 0-1.9.8-1.9 1.9s.8 1.9 1.9 1.9 1.9-.8 1.9-1.9-.9-1.9-1.9-1.9z" fill="%231E5DA7"/>
                </svg>`;
            case "markers--social--Twitter":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--social--Twitter" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    <path d="M15 30C6.8 30 0 23.2 0 15S6.8 0 15 0s15 6.8 15 15-6.8 15-15 15zm0-28.1C7.8 1.9 1.9 7.8 1.9 15S7.8 28.1 15 28.1 28.1 22.2 28.1 15 22.2 1.9 15 1.9z" fill="%231E5DA7"/>
                    <path d="M21.6 11c-.5.2-1 .4-1.5.5.6-.4.9-.8 1.2-1.5-.6.3-1.1.6-1.7.7-.5-.6-1.2-.8-2-.8-1.5 0-2.7 1.2-2.7 2.7 0 .2 0 .4.1.7-2.2-.1-4.2-1.2-5.5-2.8-.2.4-.4.8-.4 1.3 0 .9.5 1.8 1.2 2.2-.5 0-.8-.1-1.2-.4 0 1.3.9 2.4 2.2 2.6-.2.1-.5.1-.8.1-.2 0-.4 0-.5-.1.4 1 1.3 1.9 2.5 1.9-.9.8-2.1 1.1-3.4 1.1h-.7c1.2.7 2.6 1.2 4.1 1.2 5 0 7.7-4.1 7.7-7.7v-.4c.5-.4 1-.9 1.4-1.3z" fill="%231E5DA7"/>
                </svg>`;
            case "markers--social--Youtube":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--social--Youtube" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    <path d="M15 30C6.8 30 0 23.2 0 15S6.8 0 15 0s15 6.8 15 15-6.8 15-15 15zm0-28.1C7.8 1.9 1.9 7.8 1.9 15S7.8 28.1 15 28.1 28.1 22.2 28.1 15 22.2 1.9 15 1.9z" fill="%231E5DA7"/>
                    <path d="M21.6 12.4c0-1.1-.8-2.1-2-2.1h-9.2c-1.1 0-2 .9-2 2.1v5.2c0 1.1.8 2.1 2 2.1h9.2c1.1 0 2-.9 2-2.1v-5.2zm-7.9 4.8v-5l3.8 2.4-3.8 2.6z" fill="%231E5DA7"/>
                </svg>`;
            case "markers--warning--Advice":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--warning--Advice" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.2 24.9c-1 2.1 0 3.7 2.3 3.7h21.2c2.3 0 3.3-1.7 2.3-3.7l-11-22c-1-2.1-2.7-2.1-3.7 0l-11.1 22z" fill="%23FBE032"/>
            ...
            case "markers--warning--Community_Update":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--warning--Community_Update" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%231E5DA7" r="13.5"/>
                    <path d="M15 29.9C6.8 29.9.2 23.2.2 15S6.8.1 15 .1 29.9 6.8 29.9 15 23.2 29.9 15 29.9zm0-27.1C8.3 2.8 2.9 8.3 2.9 15S8.3 27.2 15 27.2 27.2 21.7 27.2 15 21.7 2.8 15 2.8z" fill="%23FFF"/>
                    <g fill="%23FFF">
            ...
            case "markers--warning--Emergency_Warning":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--warning--Emergency_Warning" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.2 24.9c-1 2.1 0 3.7 2.3 3.7h21.2c2.3 0 3.3-1.7 2.3-3.7l-11-22c-1-2.1-2.7-2.1-3.7 0l-11.1 22z" fill="%23EC0A47"/>
                    ...
                    <path d="M11.6 24.1c0-.5.4-1.4 1.5-1.4.8 0 1.4.6 1.4 1.5 0 .8-.6 1.3-1.5 1.3-.6 0-1.4-.4-1.4-1.4zm1.2-3c-.1 0-.1-.1-.1-.2-.1-2.2-1-7.8-1-8.8 0-.9.4-1.7 1.4-1.7.9 0 1.5.5 1.4 1.5 0 .9-1 6.9-1.1 9 0 .1 0 .2-.2.2h-.4z" fill="%23FFF"/>
                    <g>
                        <path d="M15.5 24.1c0-.5.4-1.4 1.5-1.4.8 0 1.4.6 1.4 1.5 0 .8-.6 1.3-1.5 1.3-.7 0-1.4-.4-1.4-1.4zm1.1-3c-.1 0-.1-.1-.1-.2-.1-2.2-1-7.8-1-8.8 0-.9.4-1.7 1.4-1.7.9 0 1.5.5 1.4 1.5 0 .9-1 6.9-1.1 9 0 .1 0 .2-.2.2h-.4z" fill="%23FFF"/>
                    </g>
                </svg>`;
            case "markers--warning--Evacuate":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--warning--Evacuate" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.1 24.9c-1 2.1 0 3.7 2.3 3.7h21.2c2.3 0 3.3-1.7 2.3-3.7l-11-22.1c-1-2.1-2.7-2.1-3.7 0L2.1 24.9z"/>
                    <path d="M25.6 30H4.5c-1.6 0-2.9-.6-3.5-1.7-.7-1.1-.7-2.5 0-3.9L12 2.3C12.7.8 13.8 0 15 0s2.3.8 3.1 2.3l11 22.1c.7 1.4.7 2.8 0 3.9-.6 1.1-1.9 1.7-3.5 1.7zM15 2.7s-.3.1-.7.8l-11 22.1c-.3.6-.3 1.1-.2 1.4.2.3.6.5 1.3.5h21.2c.6 0 1.1-.2 1.3-.5.2-.3.1-.8-.2-1.4l-11-22.1c-.3-.7-.6-.8-.7-.8z" fill="%23EC0A47"/>
                    <g fill="%23FFF">
                    ...
                    <g>
                        <path d="M16.4 21.7H20v1.4l2.4-2.3-2.4-2.4v1.4h-4.6z" fill="%23FFF"/>
                    </g>
                </svg>`;
            case "markers--warning--Warning-Watch_and_Act":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--warning--Warning-Watch_and_Act" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.2 24.9c-1 2.1 0 3.7 2.3 3.7h21.2c2.3 0 3.3-1.7 2.3-3.7l-11-22c-1-2.1-2.7-2.1-3.7 0l-11.1 22z" fill="%23F57F2F"/>
                    <path d="M25.7 30H4.5C3 30 1.7 29.4 1 28.3c-.7-1.1-.7-2.5 0-3.9L12 2.3C12.8.8 13.9 0 15.1 0s2.3.8 3.1 2.3l11 22.1c.7 1.4.7 2.8 0 3.9-.6 1.1-1.9 1.7-3.5 1.7zM15.1 2.7s-.3.1-.7.8l-11 22.1c-.3.6-.3 1.1-.2 1.4.2.3.6.5 1.3.5h21.2c.6 0 1.1-.2 1.3-.5.2-.3.1-.8-.2-1.4l-11-22.1c-.3-.7-.6-.8-.7-.8z"/>
                    <g>
            ...
            case "markers--weather--Cyclone":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Cyclone" overflow="scroll" viewBox="0 0 93.75 93.75" xmlns="http://www.w3.org/2000/svg">
                    <path d="M91.084 43.807L46.908 90.6 1.773 45.767 47.389.442z" fill="%23fff"/>
            ...
            case "markers--weather--Damaging_Winds":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Damaging_Winds" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29 .8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
            ...
            case "markers--weather--Fire_Danger_Ratings":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Fire_Danger_Ratings" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 1.9C7.8 1.9 1.9 7.8 1.9 15S7.8 28.1 15 28.1 28.1 22.2 28.1 15 22.2 1.9 15 1.9z" fill="%23FFF"/>
                    <path d="M15 0C6.8 0 0 6.8 0 15s6.8 15 15 15 15-6.8 15-15S23.2 0 15 0zm0 28.1C7.8 28.1 1.9 22.2 1.9 15S7.8 1.9 15 1.9 28.1 7.8 28.1 15 22.2 28.1 15 28.1z"/>
                    <g fill="%23231F20">
                        <path d="M16.8 13.6c.7.5 1.4 1.1 1.7 2.1l5.8-4.1c-1.1-1.8-2.8-3.1-4.7-4l-2.8 6zM26.2 17.8c0-2-.5-3.8-1.4-5.4l-6.1 4.3v.2c0 .3-.1.7-.1.9h7.6zM11.4 15.7c.3-.9.9-1.7 1.8-2.2l-2.8-6c-2 .9-3.6 2.3-4.8 4.1l5.8 4.1zM14.2 13.2c.3-.1.6-.1.8-.1.4 0 .7.1.9.1l2.8-6c-1.1-.4-2.4-.7-3.8-.7s-2.5.2-3.7.7l3 6zM11.2 16.9v-.2l-6.1-4.3c-.9 1.6-1.4 3.5-1.4 5.4h7.6c0-.3-.1-.6-.1-.9z"/>
                    </g>
                    <path d="M15.7 22.7c-.4-.6-.2-1.6-.3-1.6-2.3.4-1.6 3.1-1.6 3.1-4.4-2.9-.9-5.7-.1-6.6.8-.8.9-2.7.9-2.7 1.8 1.3.9 4.3 1 4.2.9 0 1.3-1.3 1.3-1.3 3.5 4.8-.9 6.5-.9 6.5.2-1.1.1-1.1-.3-1.6z"/>
                </svg>`;
            case "markers--weather--Flood":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Flood" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 1.3l13.7 13.4-13.9 14.4L.6 15.3z" fill="%23FFF"/>
                    <path d="M8.9 14.5h12.3v5.7H8.9z"/>
                    <path d="M6 14.9l8.9-7.5 8.8 7.5z"/>
                    <path d="M9.2 8.7h2v3.9h-2z"/>
                    <path d="M13.3 15.2h3.4v3.7h-3.4z" fill="%23FFF"/>
                    ...
                    <path d="M11.6 23.4c-.3 0-.7-.1-1-.2l-2.2-1-2.1.7-.8-2.3 2.2-.7c.5-.2 1.2-.1 1.7.1l2.2 1 2.3-.9c.5-.2 1.1-.2 1.6 0l2.4.8h.1l2-.7c.5-.2 1.1-.2 1.6-.1l2.2.6-.7 2.3-2.1-.6h-.1l-2 .8c-.5.2-1.1.2-1.6 0l-2.4-.8h-.1l-2.4.9c-.3.1-.5.1-.8.1z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7s.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
                </svg>`;
            case "markers--weather--Gauge":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Gauge" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M28.1 15c0-7.2-5.9-13.1-13.1-13.1S1.9 7.8 1.9 15" fill="%23FFF"/>
            ...
            case "markers--weather--Storm":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Storm" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 1.3l13.7 13.3L14.8 29 .6 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
            ...
            case "markers--weather--Temperature":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Temperature" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="15" cy="15" fill="%23FFF" r="14.1"/>
                    <path d="M15 30C6.8 30 0 23.2 0 15S6.8 0 15 0s15 6.8 15 15-6.8 15-15 15zm0-28.1C7.8 1.9 1.9 7.8 1.9 15S7.8 28.1 15 28.1 28.1 22.2 28.1 15 22.2 1.9 15 1.9z"/>
            ...
            case "markers--weather--Tsunami":
                return `<svg width="100%" height="100%" xmlns:xlink="http://www.w3.org/1999/xlink" id="markers--weather--Tsunami" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.1 1.3l13.8 13.3L15 29.1.8 15.2z" fill="%23FFF"/>
                    <path d="M15 30c-1.4 0-2.6-.5-3.6-1.5l-9.9-9.9C.5 17.6 0 16.4 0 15s.5-2.6 1.5-3.6l9.9-9.9C12.4.5 13.6 0 15 0s2.6.5 3.6 1.5l9.9 9.9c2 2 2 5.2 0 7.2l-9.9 9.9c-1 1-2.2 1.5-3.6 1.5zm0-27.4c-.7 0-1.3.3-1.7.7l-9.9 9.9c-.5.5-.7 1.1-.7 1.7 0 .7.3 1.3.7 1.7l9.9 9.9c.9.9 2.5.9 3.5 0l9.9-9.9c1-1 1-2.5 0-3.5l-9.9-9.9c-.5-.3-1.1-.6-1.8-.6z"/>
